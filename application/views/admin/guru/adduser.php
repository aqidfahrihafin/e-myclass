<?php $no = 1; foreach ($guru as $result) {?>
 <div class="modal fade adduser<?php echo $result['guru_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="custom-validation" action="<?php echo site_url('admin/guru/reg_user'); ?>" method="post">
