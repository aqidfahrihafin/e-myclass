                ...
                <div class="clearfix">
                    <div class="float-right">
						<div class="btn-group" role="group" aria-label="Basic example">
							<!-- <a  target="_blank" href="<?php echo site_url('admin/kategori/cetak'); ?>"class="btn btn-danger btn-sm"><i class="bx bx-printer label-icon"></i></a> -->
                    ...
                    <h4 class="card-title mb-4"><?php echo $title ?> BPI</h4>
                    <hr>
                </div>
                    ...
                    <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>Jenis Kategori BPI</th>
                                <th>Slug URL</th>
                                <th width="100px">Action</th>
                            </tr>
                        </thead>
                        <tbody>
						<?php $no = 1; foreach ($kategori as $result) {?>		
                            <tr>
                                <td><?php echo $no++; ?></td>
                                <td>
                                ...
                                <td><?php echo $result->jenis_kategori_bpi; ?></td>
                                <td><?php echo $result->slug_url; ?></td>
                                <td align="center">
									<button type="button" class="btn btn-warning btn-sm waves-effect waves-light" data-toggle="modal" data-target=".kategori<?php echo $result->kategori_id ?>">
										<i class="mdi mdi-pencil"></i>
									</button>
                                    <button type="button" class="btn btn-danger waves-effect waves-light btn-sm" data-toggle="modal" data-target=".deletekategori<?php echo $result->kategori_id ?>">
...
<!-- end row -->
<?php $this->load->view('admin/kategori/add');?>
<?php $this->load->view('admin/kategori/edit');?>
<?php $this->load->view('admin/kategori/delete');?>
