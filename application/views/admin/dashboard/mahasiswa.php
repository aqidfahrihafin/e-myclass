				...
				<div class="col-xl-12">					
					<div class="card text-center">
						<div class="card-body ">
							...
							<h5 class="font-size-15 mt-4"><a href="#" class="text-dark"><?php echo $user_data->nama_mahasiswa; ?></a></h5>
							...
							<li class="event-list active">
								...
								<div class="media">
									...
									<div class="media-body">
										<div>
											<h6 class="font-size-8"><a href="#" class="text-dark">Pengajuan Seminar Prosiding</a></h6>
				...
				<div class="col-md-4">
					<div class="card mini-stats-wid">
						<div class="card-body">
							<div class="media">
								<div class="media-body">
									<p class="text-muted font-weight-medium">Pengajuan Selesai</p>
									<h4 class="mb-0">0</h4>
								</div>
				...
				<div class="col-md-4">
					<div class="card mini-stats-wid">
						<div class="card-body">
							<div class="media">
								<div class="media-body">
									<p class="text-muted font-weight-medium">Pengajuan Pending</p>
									<h4 class="mb-0">1</h4>
								</div>
				...
				<div class="col-md-4">
					<div class="card mini-stats-wid">
						<div class="card-body">
							<div class="media">
								<div class="media-body">
									<p class="text-muted font-weight-medium">Pengajuan Ditolak</p>
									<h4 class="mb-0">1</h4>
								</div>
			...
			<div class="card">
				<div class="card-body">
					<div class="clearfix">
                        ...
                        <h6 class="mb-4"><b>Riwayat Pengajuan</b></h6>
                        <hr>
                    </div>
