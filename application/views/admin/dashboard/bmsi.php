				...
				<div class="col-xl-12">					
					<div class="card text-center">
						<div class="card-body ">
							...
							<p class="text-muted"><span class="badge badge-pill badge-primary font-size-8">admin <?php echo $user_data->role; ?></span></p>
						</div>
			...
			<div class="card">
				<div class="card-body">
					<div class="clearfix">
                        ...
                        <h6 class="mb-4"><b>Info Pencairan</b></h6>
                        <hr>
                    </div>
					<div class="">
							...
							<li class="event-list active">
								...
								<div class="media">
									...
									<div class="media-body">
										<div>
											<h6 class="font-size-8"><a href="#" class="text-dark">Pencairan Seminar Prosiding</a></h6>
				...
				<div class="col-md-4">
					<div class="card mini-stats-wid">
						<div class="card-body">
							<div class="media">
								<div class="media-body">
									<p class="text-muted font-weight-medium">Pencairan Selesai</p>
									<h4 class="mb-0">0</h4>
								</div>
				...
				<div class="col-md-4">
					<div class="card mini-stats-wid">
						<div class="card-body">
							<div class="media">
								<div class="media-body">
									<p class="text-muted font-weight-medium">Pencairan Pending</p>
									<h4 class="mb-0">1</h4>
								</div>
				...
				<div class="col-md-4">
					<div class="card mini-stats-wid">
						<div class="card-body">
							<div class="media">
								<div class="media-body">
									<p class="text-muted font-weight-medium">Pencairan Ditolak</p>
									<h4 class="mb-0">1</h4>
								</div>
			...
			<div class="card">
				<div class="card-body">
					<div class="clearfix">
                        ...
                        <h6 class="mb-4"><b>Riwayat Pencairan</b></h6>
                        <hr>
                    </div>
