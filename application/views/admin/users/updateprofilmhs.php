	<!-- add modal -->
    <div class="modal fade updateprofil<?php echo $user_data->mahasiswa_id; ?>" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered  modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
					<form action="<?php echo site_url('admin/profil/update_photo_with_qr_code_mhs/'.$user_data->mahasiswa_id); ?>" method="post" enctype="multipart/form-data">
						<div align="center">
						...
						<div class="form-group">
							...
							<div class="custom-control custom-checkbox custom-checkbox-outline  custom-checkbox-danger mb-3">
								<input type="checkbox" class="custom-control-input" id="customCheck-outlinecolor1" required>
								<label class="custom-control-label" for="customCheck-outlinecolor1"><small>Ceklis jika sudah sesuai dengan petunjuk</small></label>
							</div>
                        </div>
						<hr>
						<div align="right">
