        ...
        <div class="card border-1">
			...
			<table>
				<tr>
					...
					<td align="right"><?php echo $nama_mahasiswa; ?></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="right"><?php echo $telp_mahasiswa; ?></td>
				</tr>
				<tr>
					<td align="left">Tanggal Registrasi</td>
					<td align="right"><?php echo $tanggal_masuk; ?></td>
				</tr>
			</table>
			<br>
            ...
            <br>
            <br>
            <div align="center"><a href="<?php echo base_url('home/activate_mahasiswa/').$mahasiswa_id?>">Activate account</a></div>
            <br>
            <br>
